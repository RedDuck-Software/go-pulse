...
import (
	...
	"github.com/RedDuck-Software/go-pulse/crypto/signify"
	"github.com/RedDuck-Software/go-pulse/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/RedDuck-Software/go-pulse/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/RedDuck-Software/go-pulse/mobile")
